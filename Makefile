#############################################################################
# Makefile for building: dotcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun May 19 03:13:54 2013
# Project:  dotcoin-qt.pro
# Template: app
# Command: /usr/bin/qmake USE_UPNP=1 USE_QRCODE=1 USE_DBUS=1 FIRST_CLASS_MESSAGE=1 -o Makefile dotcoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_WEBKIT -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DSCRYPT_CHACHA -DSCRYPT_KECCAK512 -DUSE_QRCODE -DUSE_UPNP=1 -DSTATICLIB -DUSE_DBUS -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_DBUS_LIB -DQT_GUI_LIB -DQT_CORE_LIB -DQT_SHARED
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtDBus -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lqrencode -lminiupnpc -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtDBus -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: dotcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=1 USE_QRCODE=1 USE_DBUS=1 FIRST_CLASS_MESSAGE=1 -o Makefile dotcoin-qt.pro
...
/home/dotcoin/dtc/dotcoin-src/build/build.h: FORCE
	cd /home/dotcoin/dtc/dotcoin-src; /bin/sh share/genbuild.sh /home/dotcoin/dtc/dotcoin-src/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/novacoin-128.png \
