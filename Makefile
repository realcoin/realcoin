#############################################################################
# Makefile for building: realcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? ?? 20 12:04:30 2013
# Project:  realcoin-qt.pro
# Template: app
# Command: d:\Qt-mgw\4.8.4\bin\qmake.exe USE_UPNP=1 -o Makefile realcoin-qt.pro
#############################################################################
...
Makefile: realcoin-qt.pro  d:/Qt-mgw/4.8.4/mkspecs/win32-g++/qmake.conf d:/Qt-mgw/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=1 -o Makefile realcoin-qt.pro
